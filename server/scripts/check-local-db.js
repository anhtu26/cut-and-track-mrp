 ...
 * via the exposed port on localhost to check the schema and user data.
 */
...
// Main function
async function main() {
  log.title('Local Database Check');
  
  // Create a connection pool for PostgreSQL using localhost
  const pool = new Pool({
